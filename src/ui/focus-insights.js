/**
 * Focus Insights - Priority recommendations
 * Extracted from legacy app.js (lines 378-535)
 */

import { t } from "../i18n.js";
import { summaryString, fmt1 } from "./stats-helpers.js";
...
/**
 * Build focus insights from analysis context
 */
export function buildFocusInsights(context = {}) {
    const summaryText = null; // Legacy global
...
/**
 * Render focus block HTML
 */
export function renderFocusBlock(focus) {
