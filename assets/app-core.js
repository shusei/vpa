...
import { estimateAcousticPresentation } from "./js/acoustic-fast-path.js?v=1.4.3";
import { initI18n, t, getLocaleValue, onLocaleChange } from "./js/i18n.js?v=1.4.3";
import {
...
import { createAnalysisEngineBridge } from "./js/analysis-engine-bridge.js?v=1.4.3";
import {
...
import { createRecordingFlowController } from "./js/recording-flow.js?v=1.4.3";
import {
...
import { installEmbeddedBrowserGuard } from "./js/embedded-browser.js?v=1.4.3";
import {
  mobileInferenceMaxSec,
  shouldUseEmbeddedAcousticFastPath,
  shouldUseMobileFastPath,
  selectRepresentativeSamples,
} from "./js/inference-sampling.js?v=1.4.3";
...
import { createUIStateControls } from "./js/ui-state-controls.js?v=1.4.3";
