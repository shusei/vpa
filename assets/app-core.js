...
import { estimateAcousticPresentation } from "./js/acoustic-fast-path.js?v=1.4.2-20260808";
import { initI18n, t, getLocaleValue, onLocaleChange } from "./js/i18n.js?v=1.4.2-20260808";
import {
...
import { createAnalysisEngineBridge } from "./js/analysis-engine-bridge.js?v=1.4.2-20260808";
import {
...
} from "./js/player-ui.js?v=1.4.2-20260808";
...
import { createRecordingFlowController } from "./js/recording-flow.js?v=1.4.2-20260808";
import {
...
import { installEmbeddedBrowserGuard } from "./js/embedded-browser.js?v=1.4.2-20260808";
import {
  mobileInferenceMaxSec,
  shouldUseEmbeddedAcousticFastPath,
  shouldUseMobileFastPath,
  selectRepresentativeSamples,
} from "./js/inference-sampling.js?v=1.4.2-20260808";
...
import { createUIStateControls } from "./js/ui-state-controls.js?v=1.4.2-20260808";
...
// ===== 版本資訊（build 與日期） =====
void sharedFillBuildMeta((import.meta && import.meta.url) ? import.meta.url : "assets/app.js");
