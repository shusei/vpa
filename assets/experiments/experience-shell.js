import { recorderCtl } from "../app.js?v=1.4.15";
...
import {
  ...
  setLocale,
  t,
} from "../js/i18n.js?v=1.4.15";
import {
  createResultCard,
  formatAdvancedResult,
  onAdvancedResult,
  prepareAdvancedXShare,
} from "./advanced-experience.js?v=1.4.15";
import { shareResultFiles } from "./audio-share.js?v=1.4.15";
import {
  compareChallenge,
  createChallengeUrl,
  readChallenge,
} from "./challenge-link.js?v=1.4.15";
import { createDynamicCardController } from "./dynamic-card-controller.js?v=1.4.15";
import {
  getDailyPromptId,
  getStandardPromptId,
  ...
  STANDARD_PROMPT_IDS,
  STANDARD_TEST_ID,
} from "./quick-prompts.js?v=1.4.15";
import { buildShareTargets, downloadBlob } from "./share-card.js?v=1.4.15";
import {
  getPublicShareResult,
  openPublicPlatformShare,
  resetPublicShareCache,
} from "./public-share.js?v=1.4.15";
import { aggregateStandardResults } from "./standard-result.js?v=1.4.15";
