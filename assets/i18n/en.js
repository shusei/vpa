...
export default {
  ...
  help: {
    dialogHtml: [
      ...
      '<img src="assets/avatar-evelyn.jpg?v=20260802-author2" alt="Portrait of Evelyn" class="help-author-img" loading="lazy" />',
  ...
  summary: {
    ...
    focus: {
      ...
      items: {
        ...
        brightnessSharp: "Brightness tilts {{label}}—relax the tongue tip and let resonance move toward the mask.",
      },
    },
