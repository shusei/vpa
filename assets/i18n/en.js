...
export default {
  ...
  experiment: {
    ...
    quick: {
      ...
      share: {
        audioDefault: "Audio is off by default and must be confirmed for every share.",
        ...
        downloaded: "Share card downloaded.",
        downloadedWithAudio: "The card and audio were downloaded. Upload them through your chosen platform.",
        failed: "Sharing is unavailable right now. Try again later.",
        includeAudio: "Include my voice",
        open: "Share / challenge a friend",
        preview: "Preview before sharing",
        shareTitle: "My VPA voice challenge",
        shared: "Shared.",
        system: "Open device share",
        title: "Share your result",
      },
      start: "Start test",
      standard: {
        audioDefault: "Audio is off by default. If enabled, only the final standard-test line is attached.",
