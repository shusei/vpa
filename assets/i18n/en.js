export default {
  ...
  practice: {
    ...
    voiceModeLabel: "Reference voice",
    voiceModeSystem: "System TTS",
    voiceModeOneesan: "Oneesan (cloud)",
    voiceModeLoli: "Loli (cloud)",
    voiceLocaleLabel: "Voice pack locale",
    voiceLocaleZhHant: "Chinese (Traditional)",
    voiceLocaleZhHans: "Chinese (Simplified)",
    voiceLocaleEn: "English",
  ...
  info: {
    quickStartHtml: [
      ...
      '<li>Need a prompt? Open the <b>Practice phrases</b> drawer next to the record button: pick a sentence, optionally enable <b>Shadowing mode</b> (plays a reference clip and counts 3-2-1), then press <b>Record</b> or hit <kbd>Space</kbd>. Each take works best at 3–7 seconds.</li>',
    ...
    interfaceHtml: [
      ...
      '<li><b>Practice drawer:</b> sits beside the record button and lists phrases, the shadowing toggle, auto-advance, and a random pick action. Each card only shows the feminine / masculine percentages so the main meter stays uncluttered.</li>',
    ...
    methodHtml: [
      ...
      '<li><b>Practice drawer:</b> plays device TTS (skips automatically when unavailable) → counts 3-2-1 → records through the single MediaRecorder instance → writes the run’s pf / pm back to the card and stores the latest 20 entries in localStorage.</li>',
    ...
    ethicsHtml: [
      ...
      '<li>TTS note: the reference audio comes from the device’s speech synthesis voices, so timbre varies by platform.</li>',
      '</ul>',
    ].join(""),
    versionHtml: [
    ...
    compatHtml: [
      ...
      '<li>TTS: Safari / iOS may report an empty voice list on the first load; the app retries when voices appear and skips the reference clip if none are available.</li>',
      '</ul>',
    ].join(""),
  },
  help: {
    dialogHtml: [
      ...
      '<li>Need ideas? Open the <strong>Practice phrases</strong> drawer beside the record button, choose a line, and (optionally) enable <strong>Shadowing mode</strong>—it plays the reference audio, counts 3-2-1, then starts recording for you.</li>',
      ...
      '<ul>',
      '<li><strong>Pick a phrase:</strong> browse by category or tap “Random phrase”; 3–7 second takes keep the pacing natural.</li>',
      '<li><strong>Shadowing mode:</strong> plays the reference audio and counts 3-2-1 before recording; if the device has no TTS voices available, the app simply skips playback.</li>',
      '<li><strong>Auto next:</strong> scrolls to the next card and focuses its “Play reference” button so you can keep looping.</li>',
