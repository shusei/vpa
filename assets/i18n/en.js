...
export default {
  ...
  experiment: {
    ...
    quick: {
      ...
      challenge: {
        beat: "You lead by {{difference}} points!",
        behind: "You are {{difference}} points away. Try again to beat it.",
        comparison: "Friend challenge result",
        inviteScore: "They scored {{score}}. Can you beat it?",
        received: "You received a VPA voice challenge",
        tied: "You reached the same score!",
      },
      errors: {
