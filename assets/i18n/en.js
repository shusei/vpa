export default {
  ...
  info: {
    ...
    interfaceHtml: [
      ...
      '<li><b>Practice drawer:</b> sits beside the record button and lists phrases along with auto-advance and a random pick action. Each card toggles between record and stop and includes a play button for the previous take, while keeping the feminine / masculine percentages out of the main meter.</li>',
  ...
  help: {
    dialogHtml: [
      ...
      '<li><strong>Auto next:</strong> scrolls to the next card and focuses its record button so you can keep looping.</li>',
