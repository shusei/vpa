  ...
  experiment: {
    advanced: {
      ...
      share: {
        ...
        platformHint: "Platform shortcuts open a composer with an image preview, text, and the shortest link. To attach your personal result card, use the recommended share button above.",
        primary: "Share image + text + short link (recommended)",
        shared: "Shared.",
    ...
    quick: {
      ...
      dynamic: {
        ...
        clipHint: "The full recording is selected by default and is trimmed only when you change the start or end. Short recordings hold the final animation to fill 8 seconds.",
        clipRange: "{{start}}–{{end}} seconds",
        clipTitle: "Choose the voice clip for your video",
        ...
        fallbackHint: "Video export is unavailable in this browser, so the result uses a PNG card and your selected WAV voice clip.",
        generate: "Create dynamic voice card",
        loadingAudio: "Reading recording duration…",
        noAudio: "This result has no recording available. Run a new test before creating a dynamic voice card.",
        open: "Create a 9:16 dynamic voice card",
        outputDuration: "Estimated video length: {{value}} seconds",
        preview: "Play preview with sound",
        previewFailed: "The preview could not play. Try the video controls once more.",
        progress: {
          decoding: "Preparing your voice clip…",
        ...
        subtitle: "Combine the score reveal, voice character, experimental age impression, animated waveform, and your selected voice.",
      ...
      prompts: {
        arrival: "I am already on my way and should be there in about ten minutes.",
        commute: "Good morning. I may arrive a little late today, so message me when you get there.",
        dinner: "What would you like for dinner? If you have not decided, we can look together.",
        directions: "Excuse me, is there a convenience store nearby? I would like to get a drink.",
        repeat: "I did not quite hear that. Could you please say it one more time?",
        shopping: "I just finished work and plan to stop at the store. Would you like me to pick up anything?",
        timing: "Could you confirm the time for me? Would three tomorrow afternoon work?",
        weather: "It is a little cold outside today, so remember to bring an extra jacket.",
        weekend: "If the weather is nice this weekend, I would like to go for a walk. Are you free?",
        workload: "I have a few things to finish today, but I can rest once they are done.",
      },
      ...
      share: {
        ...
        directHint: "X, Threads, LINE, and Facebook share an image preview, text, and the shortest link. TikTok shares an image by default. Video is created only when you check the option below.",
        directTitle: "Quick share to a platform",
        downloaded: "Share card downloaded.",
        failed: "Sharing is unavailable right now. Try again later.",
        includeAudio: "Create a video with voice",
        open: "Share image / video",
        shareTitle: "My VPA voice challenge",
        shared: "Shared.",
        system: "Share image + text + short link",
        tiktokNeedsAudio: "TikTok sharing needs a voice video. Record a new result and try again.",
        tiktokReady: "TikTok video creation is open. When ready, tap Share video and choose TikTok.",
