...
const dictionary = {
  ...
  audioDebug: {
    download: "Download audio diagnostics",
    downloadAria: "Download audio diagnostics JSON without recorded audio",
  },
  help: {
...
,
  ...
  helpDialog: {
    dialogHtml: [
      ...
      '<img src="assets/avatar-evelyn.jpg?v=1.4.26" alt="Portrait of Evelyn" class="help-author-img" loading="lazy" />',
